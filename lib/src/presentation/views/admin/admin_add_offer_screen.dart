...
class AdminAddOfferScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => AdminAddProductsImagesBloc(context.read<AdminRepository>()),
        ),
        BlocProvider(
          create: (context) => AdminAddSelectCategoryCubit(),
        ),
        BlocProvider(
          create: (context) => SingleImageCubit(),
        ),
      ],
      child: Scaffold(
                              ...
                              if (GlobalKey<FormState>()
                                ...
                                await context
                                    ...
                                    .addFourImagesOffer(
                                        ...
                                        images: imagesList,
                                        label1: TextEditingController().text,
                                        label2: TextEditingController().text,
                                        label3: TextEditingController().text,
                                        label4: TextEditingController().text,
                                        category: category);
                              } else {
